...
import { base58, base64, Coder } from "@scure/base";
...
const T0 = bigintArrayBytes.decode(
  base64.decode(
...
const T1 = bigintArrayBytes.decode(
  base64.decode(
...
const T2 = bigintArrayBytes.decode(
  base64.decode(
...
const T3 = bigintArrayBytes.decode(
  base64.decode(
...
const T4 = bigintArrayBytes.decode(
  base64.decode(
...
const T5 = bigintArrayBytes.decode(
  base64.decode(
...
const T6 = bigintArrayBytes.decode(
  base64.decode(
...
const T7 = bigintArrayBytes.decode(
  base64.decode(
