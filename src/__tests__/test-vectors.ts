...
type TestVector = {
  name: string;
  coinType: number;
  passingVectors: Array<PassingVector>;
};

// Ordered by coinType
export const TEST_VECTORS: Array<TestVector> = [
  {
    name: "BTC",
    coinType: 0,
    passingVectors: [
  ...
  //   name: "ARDR",
  //   coinType: 16754,
  //   passingVectors: [{ text: "ARDOR-MT4P-AHG4-A4NA-CCMM2", hex: "15021913020e0f080a1313000a08021408" }],
  // },
  // {
  //   name: "ZEL",
  //   coinType: 19167,
  ...
  // {
  //   name: "OP",
  //   coinType: ethChainIdToCoinType(10),
  //   passingVectors: [
  //     { text: "0x314159265dD8dbb310642f98f50C066173C1259b", hex: "314159265dd8dbb310642f98f50c066173c1259b" },
  //   ],
  // },
  // {
  //   name: "CRO",
  //   coinType: ethChainIdToCoinType(25),
  //   passingVectors: [
  //     { text: "0x314159265dD8dbb310642f98f50C066173C1259b", hex: "314159265dd8dbb310642f98f50c066173c1259b" },
  //   ],
  // },
  // {
  //   name: "BSC",
  //   coinType: ethChainIdToCoinType(56),
  //   passingVectors: [
  //     { text: "0x314159265dD8dbb310642f98f50C066173C1259b", hex: "314159265dd8dbb310642f98f50c066173c1259b" },
  //   ],
  // },
  // {
  //   name: "GO",
  //   coinType: ethChainIdToCoinType(60),
  //   passingVectors: [
  //     { text: "0x314159265dD8dbb310642f98f50C066173C1259b", hex: "314159265dd8dbb310642f98f50c066173c1259b" },
  //   ],
  // },
  // {
  //   name: "ETC",
  //   coinType: ethChainIdToCoinType(61),
  //   passingVectors: [
  //     { text: "0x314159265dD8dbb310642f98f50C066173C1259b", hex: "314159265dd8dbb310642f98f50c066173c1259b" },
  //   ],
  // },
  // {
  //   name: "TOMO",
  //   coinType: ethChainIdToCoinType(88),
  //   passingVectors: [
  //     { text: "0xf5C9206843DAe847DdFd551ef7b850895430EcA3", hex: "f5c9206843dae847ddfd551ef7b850895430eca3" },
  //     { text: "0x15813DAE07E373DC800690031A1385eB7faDe49F", hex: "15813dae07e373dc800690031a1385eb7fade49f" },
  //   ],
  ...
  // {
  //   name: "POA",
  //   coinType: ethChainIdToCoinType(99),
  //   passingVectors: [
  //     { text: "0xF977814e90dA44bFA03b6295A0616a897441aceC", hex: "f977814e90da44bfa03b6295a0616a897441acec" },
  //     { text: "0xBE0eB53F46cd790Cd13851d5EFf43D12404d33E8", hex: "be0eb53f46cd790cd13851d5eff43d12404d33e8" },
  //   ],
  ...
  // {
  //   name: "GNO",
  //   coinType: ethChainIdToCoinType(100),
  //   passingVectors: [
  //     { text: "0x314159265dD8dbb310642f98f50C066173C1259b", hex: "314159265dd8dbb310642f98f50c066173c1259b" },
  //   ],
  // },
  // {
  //   name: "TT",
  //   coinType: ethChainIdToCoinType(108),
  //   passingVectors: [
  //     { text: "0x1001EEc06f2aDff074fC2A9492e132c33d6bd54d", hex: "1001eec06f2adff074fc2a9492e132c33d6bd54d" },
  //   ],
  // },
  // {
  //   name: "MATIC",
  //   coinType: ethChainIdToCoinType(137),
  //   passingVectors: [
  //     { text: "0x314159265dD8dbb310642f98f50C066173C1259b", hex: "314159265dd8dbb310642f98f50c066173c1259b" },
  //   ],
  // },
  // {
  //   name: "EWT",
  //   coinType: ethChainIdToCoinType(246),
  //   passingVectors: [
  //     { text: "0x2ce42c2B3aCff7eddcfd32DCB0703F1870b0eBe1", hex: "2ce42c2b3acff7eddcfd32dcb0703f1870b0ebe1" },
  //   ],
  // },
  // {
  //   name: "FTM",
  //   coinType: ethChainIdToCoinType(250),
  //   passingVectors: [
  //     { text: "0x314159265dD8dbb310642f98f50C066173C1259b", hex: "314159265dd8dbb310642f98f50c066173c1259b" },
  //   ],
  // },
  // {
  //   name: "THETA",
  //   coinType: ethChainIdToCoinType(361),
  //   passingVectors: [
  //     { text: "0x314159265dD8dbb310642f98f50C066173C1259b", hex: "314159265dd8dbb310642f98f50c066173c1259b" },
  //   ],
  // },
  // {
  //   name: "CLO",
  //   coinType: ethChainIdToCoinType(820),
  //   passingVectors: [
  //     { text: "0x5aAeb6053F3E94C9b9A09f33669435E7Ef1BeAed", hex: "5aaeb6053f3e94c9b9a09f33669435e7ef1beaed" },
  //   ],
  // },
  // {
  //   name: "NRG",
  //   coinType: ethChainIdToCoinType(39797),
  //   passingVectors: [
  //     { text: "0x7e534bc64A80e56dB3eEDBd1b54639C3A9a7CDEA", hex: "7e534bc64a80e56db3eedbd1b54639c3a9a7cdea" },
  //   ],
  // },
  // {
  //   name: "ARB1",
  //   coinType: ethChainIdToCoinType(42161),
  //   passingVectors: [
  //     { text: "0x314159265dD8dbb310642f98f50C066173C1259b", hex: "314159265dd8dbb310642f98f50c066173c1259b" },
  //   ],
  // },
  // {
  //   name: "CELO",
  //   coinType: ethChainIdToCoinType(42220),
  //   passingVectors: [
  //     { text: "0x67316300f17f063085Ca8bCa4bd3f7a5a3C66275", hex: "67316300f17f063085ca8bca4bd3f7a5a3c66275" },
  //   ],
  // },
  // {
  //   name: "AVAXC",
  //   coinType: ethChainIdToCoinType(43114),
  //   passingVectors: [
  //     { text: "0x67316300f17f063085Ca8bCa4bd3f7a5a3C66275", hex: "67316300f17f063085ca8bca4bd3f7a5a3c66275" },
  //   ],
  // },
